...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            child_process_1.default.execSync(`./gradlew -P release-type=${versionBump} bump-version`);
            const tempDir = fs_1.default.mkdtempSync('gradle-scripts');
            const tempFile = path_1.default.join(tempDir, 'init.gradle');
            fs_1.default.writeFileSync(tempFile, `rootProject {
  task 'dumpVersion' {
    println version
  }
}`);
            const newVersion = child_process_1.default.execSync(`./gradlew -I ${tempFile} dumpVersion`).toString();
            fs_1.default.rmdirSync(tempDir);
            yield git.commit(`Bumped ${versionBump} version to ${newVersion}`);
            yield git.push();
